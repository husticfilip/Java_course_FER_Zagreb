...
public class LsCommand implements ShellCommand {
	...
	public ShellStatus executeCommand(Environment env, String arguments) {
		...
		Path pathTodir = null;
		try {
			pathTodir = getPathToDir(env,arguments);
	 ...
	 * <p>
	 * If nothing is given through arguments path is considered current directory
	 ...
	 * 
	 */
	public Path getPathToDir(Environment env, String arguments) {
		// current directory
		...
		if (!pathTodir.isAbsolute()) {
			pathTodir = env.getCurrentDirectory().resolve(pathTodir);
		}
