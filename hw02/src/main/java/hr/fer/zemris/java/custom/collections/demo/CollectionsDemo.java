...
import hr.fer.zemris.java.custom.collections.ArrayIndexCollection;
...
public class CollectionsDemo {
	...
	/**
	 * Main method which operates with collections and checks if they 
	 * are working well.
	 * @param args	
	 */
	public static void main(String[] args) {
		ArrayIndexCollection col = new ArrayIndexCollection(2);
