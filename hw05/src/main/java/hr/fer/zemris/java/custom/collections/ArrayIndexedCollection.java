...
public class ArrayIndexedCollection<T> implements List<T> {
	 ...
	 */
	public ArrayIndexedCollection(Collection<T> otherCollection) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public ArrayIndexedCollection(Collection<T> otherCollection, int initialCapacity) {
	...
	public ElementsGetter<T> createElementsGetter() {
		return new ArrayIndexElementsGetter<T>(this);
	}
	 ...
	 *
	 */
	private static class ArrayIndexElementsGetter<E> implements ElementsGetter<E> {
		 ...
		 */
		private ArrayIndexElementsGetter(ArrayIndexedCollection<E> collection) {
			this.atIndex = 0;
